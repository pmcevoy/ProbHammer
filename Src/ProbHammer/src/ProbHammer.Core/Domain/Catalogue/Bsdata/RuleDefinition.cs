...
/// faction/library rule (`rules`, catalogue level) - carried through as opaque display text.
/// </summary>
...
/// content decisions never belong on this project's per-page rendering.</param>
