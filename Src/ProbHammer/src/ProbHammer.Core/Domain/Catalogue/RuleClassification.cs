...
/// defaults to false: true only when at least one Effect was extracted AND real text remains,
/// structurally, after the last regex match that contributed to either Target or Effects. The
/// default `false` is deliberately the "boring default" the schema-growth backfill reads off this
