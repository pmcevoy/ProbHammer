...
/// resolution. Since apply-rule-effect-baseline,
...
/// <see cref="RuleClassificationBaseline"/>, replacing the old closed
/// <c>StatlineFlagRuleCatalogue</c> vocabulary entirely.</summary>
