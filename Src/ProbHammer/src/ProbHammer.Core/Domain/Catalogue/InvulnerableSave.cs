...
/// <see cref="InvulnerableSaveCharacteristicView"/>, not this value.</summary>
public sealed record InvulnerableSave(int MeleeInSv, int RangedInSv)
{
    ...
    /// convention for a specific, named, frequently-constructed value rather than an arbitrary
    /// one.</summary>
