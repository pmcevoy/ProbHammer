...
/// depending on or resolving against any catalogue data. Throws ArmyListParseException with a
/// diagnostic when the text doesn't match the shapes this parser recognizes - never guesses a
