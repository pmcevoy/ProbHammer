...
/// its total model count. Carries the offending unit name and the raw wargear text as properties,
/// not just baked into the message, mirroring AmbiguousCharacteristicException's existing
/// convention.</summary>
