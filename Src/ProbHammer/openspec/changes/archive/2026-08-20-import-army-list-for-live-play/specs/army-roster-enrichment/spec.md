...
`Datasheet`. The system SHALL fail with a diagnostic naming the unresolved text when any name does
not resolve.
...
- **WHEN** a parsed unit or weapon name does not match any entry in the resolved catalogue closure
